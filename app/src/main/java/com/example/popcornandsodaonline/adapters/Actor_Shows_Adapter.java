...
public class Actor_Shows_Adapter extends RecyclerView.Adapter<Actor_Shows_Adapter.MyViewHolder>{

    Context context;
    List<Show> list;

    public Actor_Shows_Adapter(Context context, List<Show> list) {
    ...
    @NonNull
    @Override
    public Actor_Shows_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_horizontal_list_movie_production, viewGroup, false);
        return new Actor_Shows_Adapter.MyViewHolder((view));
    }

    @Override
    public void onBindViewHolder(@NonNull Actor_Shows_Adapter.MyViewHolder myViewHolder, int i) {
