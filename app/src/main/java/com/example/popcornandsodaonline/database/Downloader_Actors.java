...
public class Downloader_Actors extends AsyncTask<Void, Void, String> {
    ...
    public Downloader_Actors(Context c, Activity activity, String urlAdress, GridView gv) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if (s == null) {
            ...
            //call parser
            DataParser_Actors parser_actors = new DataParser_Actors(c, downloadData, this.activity, gv);
            parser_actors.execute();
        }
    }
