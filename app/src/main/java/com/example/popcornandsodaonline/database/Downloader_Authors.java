...
public class Downloader_Authors extends AsyncTask<Void, Void, String> {
    ...
    public Downloader_Authors(Context c, Activity activity, String urlAdress, GridView gv) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if (s == null) {
            ...
            //call parser
            DataParser_Authors parser_authors = new DataParser_Authors(c, downloadData, this.activity, gv);
            parser_authors.execute();
        }
    }
