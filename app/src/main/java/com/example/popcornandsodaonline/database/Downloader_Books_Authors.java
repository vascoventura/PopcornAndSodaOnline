...
public class Downloader_Books_Authors extends AsyncTask<Void, Void, String> {
    ...
    public Downloader_Books_Authors(Context c, Activity activity, String urlAdress, RecyclerView recyclerView) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s==null){
            ...
            //call parser
            DataParser_Books_Authors parser_movies_production = new DataParser_Books_Authors(c, downloadData, this.activity, recyclerView);
