...
public class Downloader_Detail_Actors extends AsyncTask<Void, Void, String> {
    ...
    public Downloader_Detail_Actors(Context c, Activity activity, String urlAdress, ViewPager sliderpager) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s==null){
            ...
            //call parser
            DataParser_Detail_Actors parser_productions = new DataParser_Detail_Actors(c, downloadData, this.activity, sliderpager);
