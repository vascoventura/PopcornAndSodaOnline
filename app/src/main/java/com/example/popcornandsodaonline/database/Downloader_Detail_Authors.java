...
public class Downloader_Detail_Authors extends AsyncTask<Void, Void, String> {
    ...
    public Downloader_Detail_Authors(Context c, Activity activity, String urlAdress, ViewPager sliderpager) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s==null){
            ...
            //call parser
            DataParser_Detail_Authors parser_productions = new DataParser_Detail_Authors(c, downloadData, this.activity, sliderpager);
