...
public class Downloader_Movies_Actors extends AsyncTask<Void, Void, String> {
    ...
    public Downloader_Movies_Actors(Context c, Activity activity, String urlAdress, RecyclerView recyclerView) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s==null){
            ...
            //call parser
            DataParser_Actors_Movies parser_movies_production = new DataParser_Actors_Movies(c, downloadData, this.activity, recyclerView);
