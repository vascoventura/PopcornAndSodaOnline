...
public class Downloader_Productors_Movies extends AsyncTask<Void, Void, String> {
    ...
    public Downloader_Productors_Movies(Context c, Activity activity, String urlAdress, RecyclerView recyclerView) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s==null){
            ...
            //call parser
            DataParser_Movies_Production parser_movies_production = new DataParser_Movies_Production(c, downloadData, this.activity, recyclerView);
