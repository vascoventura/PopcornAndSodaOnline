...
public class Downloader_Shows extends AsyncTask<Void, Void, String> {
    ...
    public Downloader_Shows(Context c, Activity activity, String urlAdress, GridView gv) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s==null){
            ...
            //call parser
            DataParser_Shows parser_shows = new DataParser_Shows(c, downloadData, this.activity, gv);
            parser_shows.execute();
        }
    }
