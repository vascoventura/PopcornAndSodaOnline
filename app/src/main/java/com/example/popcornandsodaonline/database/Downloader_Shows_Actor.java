...
public class Downloader_Shows_Actor extends AsyncTask<Void, Void, String> {
    ...
    public Downloader_Shows_Actor(Context c, Activity activity, String urlAdress, RecyclerView recyclerView) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s==null){
            ...
            //call parser
            DataParser_Actors_Shows parser_movies_production = new DataParser_Actors_Shows(c, downloadData, this.activity, recyclerView);
