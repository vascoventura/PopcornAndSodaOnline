...
public class Downloader_Shows_Productors extends AsyncTask<Void, Void, String> {
    ...
    public Downloader_Shows_Productors(Context c, Activity activity, String urlAdress, RecyclerView recyclerView) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s==null){
            ...
            //call parser
            DataParser_Productors_Shows parser_movies_production = new DataParser_Productors_Shows(c, downloadData, this.activity, recyclerView);
